...
class myYOLO(nn.Module):
    ...
    def create_grid(self, input_size):
        ...
        # 从（7，7，2）变成 （1，7x7，1,2） 多的1代表对应的一个anchor box
    ...
    def forward(self, x, target=None):
        ...
        # train
        if self.trainable:
            txtytwth_pred = txtytwth_pred.view(B, H*W, self.num_classes, 4)
            # decode bbox
        ...
        # test
            ...
            with torch.no_grad():
                ...
                bboxes = torch.clamp((self.decode_boxes(txtytwth_pred) / self.input_size)[0], 0., 1.0)
...
if __name__ == "__main__":
    ...
    print(a)
    a = a.reshape((1, 5, 4)).transpose((1, 0 ,2))
    print(a)
